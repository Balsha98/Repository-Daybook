...
export function MobileDateButton() {
    ...
    return (
        <button
            type="button"
            className="flex items-center h-9 px-4 text-[14px] font-semibold border border-hairline rounded-full cursor-pointer hover:text-accent hover:border-accent lg:hidden"
